...
import { QueryNotificationsInput } from './schemas';
...
export class NotificationsService {
  ...
  async getNotifications(userId: string, query: QueryNotificationsInput): Promise<PaginatedResponse<NotificationResponse>> {
